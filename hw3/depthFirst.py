...
print 'Best combination of items in a sack that can hold {0:d}'.format(weight)
...
for i in range(0, len(solution.itemsInSack)):
	print '{0:25} {1:<10d} {2:d}'.format(
		solution.itemsInSack[i].description,
		solution.itemsInSack[i].weight,
		solution.itemsInSack[i].value
	)
